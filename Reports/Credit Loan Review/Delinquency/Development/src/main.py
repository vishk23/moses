"""
Delinquency Report main entry point
- Developed by CD
- v2.0.0-prod
...
from openpyxl.styles import Font, Border, Side, Alignment # type: ignore
...
def main():
    ...
    output_dir = r"\\00-da1\Home\Share\Data & Analytics Initiatives\Project Management\Credit_Loan_Review\Resolution Committee Automation\Delinquency\Production\Output"
    ...
    subject = f"Delinquency Report - ME: {most_recent_month_end_str}"
    body = "Hi all, \n\nAttached is the monthly Delinquency report for the Resolution Committee Package. If you have any questions, please reach out to BusinessIntelligence@bcsbmail.com"
