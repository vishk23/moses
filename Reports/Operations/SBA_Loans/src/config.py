...
# Report Info
REPORT_NAME = "SBA Loans Report Request Sep 2025"
BUSINESS_LINE = "Operations"
SCHEDULE = "On-Demand"
OWNER = "Kelly Masefield"
...
BASE_PATH = Path(r"\\00-da1\Home\Share\Data & Analytics Initiatives\Project Management\Operations\SBA_Loans_Sep2025") if ENV == 'prod' else Path(__file__).parent.parent
