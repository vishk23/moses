...
# Report Info
REPORT_NAME = "Loan Trial - Operations"
BUSINESS_LINE = "Operations"
SCHEDULE = "Monthly"
OWNER = "Kelly Masefield & Kelly Abernathy"
...
BASE_PATH = Path(r"\\00-da1\Home\Share\Data & Analytics Initiatives\Project Management\Operations\Trial Balance Ops") if ENV == 'prod' else Path(__file__).parent.parent
