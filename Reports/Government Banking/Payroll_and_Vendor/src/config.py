...
BASE_PATH = Path(r"\\00-DA1\Home\Share\Data & Analytics Initiatives\Project Management\Government Banking\Payroll_and_Vendor\Production") if ENV == 'prod' else Path(__file__).parent.parent
