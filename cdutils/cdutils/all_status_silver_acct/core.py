...
import cdutils.all_status_silver_acct.additional_fields # type: ignore
import cdutils.all_status_silver_acct.fetch_data # type: ignore
import cdutils.all_status_silver_acct.core_transform # type: ignore
...
def query_df_on_date(specified_date: Optional[datetime] = None):
    ...
    data = cdutils.all_status_silver_acct.fetch_data.fetch_data(specified_date)

    # # # Core transformation pipeline
    raw_data = cdutils.all_status_silver_acct.core_transform.main_pipeline(data)
    ...
    additional_fields = cdutils.all_status_silver_acct.additional_fields.fetch_data(specified_date)
